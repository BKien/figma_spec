...
This endpoint inherits [Common Contract](common-contract.md). Subsequent representations are available from the session-state endpoint. Media delivery is outside this JSON endpoint.
