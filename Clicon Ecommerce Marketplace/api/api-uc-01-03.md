# API-UC-01-03 — POST /api/v1/auth/resend-verification
...
Register Account and Verify Email — POST /api/v1/auth/resend-verification
...
Provides the wire operation referenced by the supplied Register Account and Verify Email specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-01-register-and-verify-email.md). Business behavior is specified by [UC-01](../uc/uc-01-register-and-verify-email.md).
