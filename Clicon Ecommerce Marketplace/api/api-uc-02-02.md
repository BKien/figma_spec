...
Sign In — GET /api/v1/auth/session
...
Provides the wire operation referenced by the supplied Sign In specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-02-sign-in.md). Business behavior is specified by [UC-02](../uc/uc-02-sign-in.md).
