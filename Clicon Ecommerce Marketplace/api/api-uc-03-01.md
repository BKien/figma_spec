# API-UC-03-01 — POST /api/v1/auth/forgot-password
...
Recover Password — POST /api/v1/auth/forgot-password
...
Provides the wire operation referenced by the supplied Recover Password specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-03-recover-password.md). Business behavior is specified by [UC-03](../uc/uc-03-recover-password.md).
