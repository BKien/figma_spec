# API-UC-07-03 — GET /api/v1/checkout/quotes/:quoteId
...
Checkout and Place Order — GET /api/v1/checkout/quotes/:quoteId
...
`/api/v1/checkout/quotes/:quoteId`
