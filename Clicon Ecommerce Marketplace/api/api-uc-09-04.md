# API-UC-09-04 — DELETE /api/v1/wishlist/items/:variantId
...
Manage Wishlist — DELETE /api/v1/wishlist/items/:variantId
...
Provides the wire operation referenced by the supplied Manage Wishlist specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-09-manage-wishlist.md). Business behavior is specified by [UC-09](../uc/uc-09-manage-wishlist.md).
