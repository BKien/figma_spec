# API-UC-12-01 — POST /api/v1/auth/change-password
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-12-change-password.md). Business behavior is specified by [UC-12](../uc/uc-12-change-password.md).
