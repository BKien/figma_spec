# API-UC-13-02 — PUT /api/v1/account/addresses/:type
...
Manage Saved Billing and Shipping Addresses — PUT /api/v1/account/addresses/:type
...
`/api/v1/account/addresses/:type`

## Description

Provides the wire operation referenced by the supplied Manage Saved Billing and Shipping Addresses specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-13-manage-saved-addresses.md). Business behavior is specified by [UC-13](../uc/uc-13-manage-saved-addresses.md).
