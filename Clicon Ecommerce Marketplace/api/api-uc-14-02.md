# API-UC-14-02 — PUT /api/v1/account/browsing-history/preference
...
View and Manage Browsing History — PUT /api/v1/account/browsing-history/preference
...
`/api/v1/account/browsing-history/preference`

## Description

Provides the wire operation referenced by the supplied View and Manage Browsing History specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-14-manage-browsing-history.md). Business behavior is specified by [UC-14](../uc/uc-14-manage-browsing-history.md).
