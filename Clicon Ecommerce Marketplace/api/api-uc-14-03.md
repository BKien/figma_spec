# API-UC-14-03 — POST /api/v1/account/browsing-history/views
...
View and Manage Browsing History — POST /api/v1/account/browsing-history/views
...
`/api/v1/account/browsing-history/views`
