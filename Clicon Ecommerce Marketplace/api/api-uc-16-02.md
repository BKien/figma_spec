# API-UC-16-02 — GET /api/v1/checkout/orders/:orderId
...
View Order Details — GET /api/v1/checkout/orders/:orderId
...
Provides the wire operation referenced by the supplied View Order Details specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-16-view-order-details.md). Business behavior is specified by [UC-16](../uc/uc-16-view-order-details.md).
