# API-UC-17-02 — POST /api/v1/account/orders/:orderId/review
...
Rate a Delivered Order — POST /api/v1/account/orders/:orderId/review
...
`/api/v1/account/orders/:orderId/review`

## Description

Provides the wire operation referenced by the supplied Rate a Delivered Order specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-17-rate-delivered-order.md). Business behavior is specified by [UC-17](../uc/uc-17-rate-delivered-order.md).
