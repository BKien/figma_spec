# API-UC-19-01 — POST /api/v1/support/requests
...
Submit a Support Request — POST /api/v1/support/requests
...
Provides the wire operation referenced by the supplied Submit a Support Request specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/clicon-uc-19-submit-support-request.md). Business behavior is specified by [UC-19](../uc/uc-19-submit-support-request.md).
