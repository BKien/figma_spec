# API-UC-01-01 — POST /api/v1/auth/job-seeker-registrations
...
Register a Job Seeker Account — POST /api/v1/auth/job-seeker-registrations
...
`/api/v1/auth/job-seeker-registrations`

## Description

Provides the wire operation referenced by the supplied Register a Job Seeker Account specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/dh-dental-uc-01-register-job-seeker.md). Business behavior is specified by [UC-01](../uc/uc-01-register-job-seeker.md).
