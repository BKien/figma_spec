# API-UC-10-03 — DELETE /api/v1/job-seeker/introduction-video
...
Record and Manage an Introduction Video — DELETE /api/v1/job-seeker/introduction-video
...
`/api/v1/job-seeker/introduction-video`
