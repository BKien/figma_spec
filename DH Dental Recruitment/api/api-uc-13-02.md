# API-UC-13-02 — GET /api/v1/auth/session
...
Sign Out — GET /api/v1/auth/session
...
Provides the wire operation referenced by the supplied Sign Out specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/dh-dental-uc-13-sign-out.md). Business behavior is specified by [UC-13](../uc/uc-13-sign-out.md).
