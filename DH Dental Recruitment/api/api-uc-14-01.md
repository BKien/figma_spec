# API-UC-14-01 — POST /api/v1/auth/account-closure
...
Permanently Close Account — POST /api/v1/auth/account-closure
...
Provides the wire operation referenced by the supplied Permanently Close Account specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/dh-dental-uc-14-close-account.md). Business behavior is specified by [UC-14](../uc/uc-14-close-account.md).
