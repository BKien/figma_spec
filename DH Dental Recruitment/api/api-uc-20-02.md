# API-UC-20-02 — POST /api/v1/job-seeker/jobs/:jobId/application
...
Submit a Job Application — POST /api/v1/job-seeker/jobs/:jobId/application
...
`/api/v1/job-seeker/jobs/:jobId/application`

## Description

Provides the wire operation referenced by the supplied Submit a Job Application specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/dh-dental-uc-20-submit-job-application.md). Business behavior is specified by [UC-20](../uc/uc-20-submit-job-application.md).
