...
**TRG-UC-16-01** — The actor opens the Submit a Contact Message interface.
...
- [Supporting Figma node 1](https://www.figma.com/design/5PvZvQ4E6DepIhbL8D35cV/DH-Dental-Recruitment--Community-?node-id=2-2802)
- [Supporting Figma node 2](https://www.figma.com/design/5PvZvQ4E6DepIhbL8D35cV/DH-Dental-Recruitment--Community-?node-id=2-5410)
...
The complete supplied specification is preserved byte-for-byte at [dh-dental-uc-16-submit-contact-message.md](../source/dh-dental-uc-16-submit-contact-message.md). It remains authoritative for detailed flows, payloads, response examples, errors, implementation context, and validation behavior.
