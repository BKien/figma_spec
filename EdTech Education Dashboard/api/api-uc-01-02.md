# API-UC-01-02 — POST /api/v1/auth/registrations/:registrationId/verify
...
Register a Student Account and Verify Email — POST /api/v1/auth/registrations/:registrationId/verify
...
`/api/v1/auth/registrations/:registrationId/verify`
