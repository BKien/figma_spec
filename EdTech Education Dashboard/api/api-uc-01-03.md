# API-UC-01-03 — POST /api/v1/auth/registrations/:registrationId/resend
...
Register a Student Account and Verify Email — POST /api/v1/auth/registrations/:registrationId/resend
...
`/api/v1/auth/registrations/:registrationId/resend`

## Description

Provides the wire operation referenced by the supplied Register a Student Account and Verify Email specification.
...
- Example: `example-registrationId`
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-01-register-student.md). Business behavior is specified by [UC-01](../uc/uc-01-register-student.md).
