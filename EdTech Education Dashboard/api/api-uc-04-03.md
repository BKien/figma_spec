# API-UC-04-03 — GET /api/v1/student/catalog/courses/:courseId
...
Discover Courses — GET /api/v1/student/catalog/courses/:courseId
...
`/api/v1/student/catalog/courses/:courseId`

## Description

Provides the wire operation referenced by the supplied Discover Courses specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-04-discover-courses.md). Business behavior is specified by [UC-04](../uc/uc-04-discover-courses.md).
