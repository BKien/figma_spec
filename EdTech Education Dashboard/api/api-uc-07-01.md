# API-UC-07-01 — GET /api/v1/student/courses/:courseId/content
...
View Course Modules and Learning Content — GET /api/v1/student/courses/:courseId/content
...
`/api/v1/student/courses/:courseId/content`

## Description

Provides the wire operation referenced by the supplied View Course Modules and Learning Content specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-07-view-course-content.md). Business behavior is specified by [UC-07](../uc/uc-07-view-course-content.md).
