# API-UC-08-01 — GET /api/v1/student/courses/:courseId/units/:unitId/video
...
Watch a Video Lesson and Save Progress — GET /api/v1/student/courses/:courseId/units/:unitId/video
...
`/api/v1/student/courses/:courseId/units/:unitId/video`
