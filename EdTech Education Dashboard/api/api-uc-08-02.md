# API-UC-08-02 — PUT /api/v1/student/courses/:courseId/units/:unitId/video/progress
...
Watch a Video Lesson and Save Progress — PUT /api/v1/student/courses/:courseId/units/:unitId/video/progress
...
`/api/v1/student/courses/:courseId/units/:unitId/video/progress`

## Description

Provides the wire operation referenced by the supplied Watch a Video Lesson and Save Progress specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-08-watch-video-lesson.md). Business behavior is specified by [UC-08](../uc/uc-08-watch-video-lesson.md).
