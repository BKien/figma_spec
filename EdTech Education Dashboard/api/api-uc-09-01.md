# API-UC-09-01 — GET /api/v1/student/courses/:courseId/units/:unitId/quiz
...
Take a Course Quiz and View the Result — GET /api/v1/student/courses/:courseId/units/:unitId/quiz
...
`/api/v1/student/courses/:courseId/units/:unitId/quiz`
