# API-UC-09-02 — POST /api/v1/student/courses/:courseId/units/:unitId/quiz/attempts
...
Take a Course Quiz and View the Result — POST /api/v1/student/courses/:courseId/units/:unitId/quiz/attempts
...
`/api/v1/student/courses/:courseId/units/:unitId/quiz/attempts`
