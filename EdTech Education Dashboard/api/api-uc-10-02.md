# API-UC-10-02 — PUT /api/v1/student/profile
...
View and Update Student Contact Profile — PUT /api/v1/student/profile
...
Provides the wire operation referenced by the supplied View and Update Student Contact Profile specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-10-update-student-profile.md). Business behavior is specified by [UC-10](../uc/uc-10-update-student-profile.md).
