# API-UC-12-02 — PUT /api/v1/student/notification-preferences
...
Manage Notification Preferences — PUT /api/v1/student/notification-preferences
...
`/api/v1/student/notification-preferences`
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-12-manage-notification-preferences.md). Business behavior is specified by [UC-12](../uc/uc-12-manage-notification-preferences.md).
