# API-UC-16-01 — POST /api/v1/auth/instructor-registrations
...
Register an Instructor Account — POST /api/v1/auth/instructor-registrations
...
`/api/v1/auth/instructor-registrations`
