# API-UC-16-03 — POST /api/v1/auth/registrations/:registrationId/resend
...
Register an Instructor Account — POST /api/v1/auth/registrations/:registrationId/resend
...
Provides the wire operation referenced by the supplied Register an Instructor Account specification.
...
Detailed endpoint fields, status codes, examples, and public outcomes are preserved in [the supplied source](../source/edtech-uc-16-register-instructor.md). Business behavior is specified by [UC-16](../uc/uc-16-register-instructor.md).
