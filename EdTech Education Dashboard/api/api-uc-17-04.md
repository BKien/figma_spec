# API-UC-17-04 — PUT /api/v1/instructor/courses/:courseId/draft
...
Create and Edit a Course Draft — PUT /api/v1/instructor/courses/:courseId/draft
...
`/api/v1/instructor/courses/:courseId/draft`
