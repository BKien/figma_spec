# API-UC-18-03 — GET /api/v1/instructor/courses/:courseId/enrollments
...
Publish a Course and Assign Learners — GET /api/v1/instructor/courses/:courseId/enrollments
