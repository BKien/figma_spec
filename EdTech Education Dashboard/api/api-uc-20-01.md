# API-UC-20-01 — GET /api/v1/instructor/courses/:courseId/schedule
...
Manage Course Learning Deadlines — GET /api/v1/instructor/courses/:courseId/schedule
...
`/api/v1/instructor/courses/:courseId/schedule`
