...
**TRG-UC-13-01** — The actor opens the Change the Current Account Password interface.
...
- [Supporting Figma node 1](https://www.figma.com/design/JDzl2rsSdGcA8tgcDG4kgy/EdTech?node-id=222-334)
- [Supporting Figma node 2](https://www.figma.com/design/JDzl2rsSdGcA8tgcDG4kgy/EdTech?node-id=222-2)
...
The complete supplied specification is preserved byte-for-byte at [edtech-uc-13-change-password.md](../source/edtech-uc-13-change-password.md). It remains authoritative for detailed flows, payloads, response examples, errors, implementation context, and validation behavior.
