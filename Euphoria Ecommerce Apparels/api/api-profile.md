...
- `UC-11` — [specification](../uc/uc-11-view-profile.md)
...
Read profile for the web client. Request and response objects are defined in [common wire definitions](common-contract.md).
...
- Description: Profile object; all nested fields are defined in common-contract.md.
- Example: `{"id": "cust_01", "name": "Alex Lee", "email": "alex@example.com", "phone": null}`.
