# API-ADMIN-BOOKING-UPDATE — Update a Booking as Admin
...
Accepts the displayed update a booking as admin interaction and returns its public result.
...
The common response envelope and pagination conventions are defined in [common-contract.md](common-contract.md). Business behavior is specified only in [UC-16](../uc/uc-16-update-admin-booking.md).
