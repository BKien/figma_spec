...
| [UC-03](uc/uc-03-view-the-home-page.md) | Published editorial destinations, moderated reviews, stable tie-breaks, supported service entries, read-only content, privacy-safe review projections, and same-currency price evidence from the previous 24 hours. | BR-UC-03-01 through BR-UC-03-08 |
...
| [UC-08](uc/uc-08-book-a-stay.md) | An authenticated quote owner, server-derived request fingerprint, separate replay/new-booking paths, quoted commercial terms, atomic consumption, payment authorization, single provider reservation, guest contact persistence and quote nonreservation. | BR-UC-08-01 through BR-UC-08-15 |
| [UC-09](uc/uc-09-search-for-taxis.md) | Active taxi service areas, pickup 2–4320 hours ahead (180 days), a party of 1–16, distinct route endpoints and positive duration, live free resources, deduplication and one comparison currency. | BR-UC-09-01 through BR-UC-09-09 |
| [UC-10](uc/uc-10-view-taxi-results.md) | Exact slices of an immutable taxi-search observation, coherent pagination, snapshot-time liveness, distinct IDs, stable order and currency consistency. | BR-UC-10-01 through BR-UC-10-07 |
| [UC-11](uc/uc-11-filter-and-sort-taxi-results.md) | Conjunctive optional price/vehicle filters, party-size matching, stable sorting, coherent bounds, a fresh traversal when refinements change, and ID/version-bound continuation. | BR-UC-11-01 through BR-UC-11-08 |
| [UC-12](uc/uc-12-view-taxi-and-driver-details.md) | A live offer or access through an owned confirmed booking, correct assigned resources, driver contact projection, vehicle-identity projection, no allocation during retrieval, coherent route times and fare currency. | BR-UC-12-01 through BR-UC-12-07 |
| [UC-13](uc/uc-13-book-a-taxi.md) | An authenticated quote owner, payment mode, server-derived request fingerprint, safe replay, overlap exclusion across offers sharing driver/vehicle, quoted terms, guest persistence and quote nonreservation. PAY_DRIVER has no payment-reference row; ONLINE uses pending/authorized payment. | BR-UC-13-01 through BR-UC-13-15 |
...
- Search currency defaults to USD; sort defaults to RECOMMENDED for stays/taxis and BEST for flights. Omitted scalar filters have no bound and omitted list filters are empty. Snapshots expire no later than any included offer observation. Search IDs and versions are supplied together.
...
- Taxi allocations use half-open intervals. Adjacent journeys can share a resource; overlapping active journeys cannot. Resource claims must be created and released in the same database transaction as booking changes. The supplemental PostgreSQL exclusion constraints represent concurrency enforcement.
