...
This directory contains the English API contracts related to the 18 supported use cases.
...
- [API-TAXI-SEARCH — Search Taxis](api-taxi-search.md)
- [API-TAXI-OFFER-DETAIL — Get Taxi Offer Details](api-taxi-offer-detail.md)
- [API-TAXI-QUOTE — Quote a Taxi Booking](api-taxi-quote.md)
- [API-TAXI-BOOKING-CREATE — Create a Taxi Booking](api-taxi-booking-create.md)
